...
{
    class ImageFactoryProjectileDagger 
    {
        ...
        private static ImageFactoryProjectileDagger imageFactory = new ImageFactoryProjectileDagger();
        public static ImageFactoryProjectileDagger Instance
        {
            get
            {
                return imageFactory;
